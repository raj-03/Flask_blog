...
def register():
    ...
    #Checking if the user is already registered or logged in
...
@login_required  #This deligater is used to make the login required, before accessing the account page.
def account():
